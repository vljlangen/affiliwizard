...
class AuthorAffiliationsApp:
    def __init__(self, root):
        self.root = root
        root.title("AffiliWizard v1.0.0")
        usage_text = (
            "How to use:\n\n"
        ...
        self.create_btn = tk.Button(btn_frame, text="Create .docx File", command=self.process)
        self.create_btn.grid(row=0, column=0, padx=2, pady=2)
        self.create_html_btn = tk.Button(btn_frame, text="Create HTML File", command=self.process_html)
        self.create_html_btn.grid(row=0, column=1, padx=2, pady=2)
        self.create_txt_btn = tk.Button(btn_frame, text="Create Plain Text File", command=self.process_txt)
        self.create_txt_btn.grid(row=0, column=2, padx=2, pady=2)
        self.example_excel_btn = tk.Button(btn_frame, text="Download Example Excel File", command=self.download_example_excel)
        self.example_excel_btn.grid(row=1, column=0, columnspan=2, padx=2, pady=2, sticky='ew')
        self.quit_btn = tk.Button(btn_frame, text="Quit", command=root.quit, fg="red")
        self.quit_btn.grid(row=1, column=2, padx=10, pady=2)
